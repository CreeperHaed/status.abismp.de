...
STATUS_CHANNEL_ID = 1355954638549156040
JOIN_CHANNEL_ID = 1355803293229781077
VC_CATEGORY_ID = 1355803293229781075

TICKET_CATEGORY_ID = 1358881377847873636
LOG_CHANNEL_ID = 1358892785666883684
TRANSCRIPT_FOLDER = "transcripts"

STAFF_ROLE_ID = 1355810486901538998
HOSTER_ROLE_ID = 1355952121689804810
OWNER_ID = 825736363814289448
OWNER_NAME = "creeperhaed"

ROLES = {
    "Java": ("💻", 1370167270860525569),
    "Bedrock": ("🎮", 1370167225901645864)
}
...
ticket_embed_title = "Create a Ticket"
click_the_button_below_to_create_a_ticket = "Click the button below to create a ticket!"
create_ticket = "Create Ticket"

how_can_we_help_you = "Select a ticket type:"
choose_category = "How can we help you?"
...
greeting = "Hello {user}! Staff will assist you shortly.."
call_staff = "Call Staff"
close_ticket = "Close Ticket"
calls_staff = "🔔 {user} called <@&{staff_id}>!"

ticket_repaired = "🔧 Ticket fixed!"
buttons_refreshed = "The Buttons have been updated!"
deleted_files_and_folders = "🧹 Deleted {deleted_files} test file{s1} and {deleted_folders} empty folder{s2}."

self_asignable_roles = "📋 Self-Assignable Roles"
click_a_button_below_to_change_a_role = "Click a button below to get/remove a role!"
...
LOG_EMBED = {
    "title_opened": "New Ticket Created",
    "title_closed": "Ticket Closed",
    "ticket": "Ticket",
    "type": "Type",
    "creator": "Created by",
...
TRANSCRIPT = {
    ...
    "creator_left": "(⚠️ Member left the Server ⚠️)"
}
ERRORS = {
    "can_only_be_closed_by": "❌ only the ticket creator or the moderators can close the ticket!",
    "only_creator_can_call": "❌ only the ticket creator can call the mods!",
    "command_only_in_tickets": "❌ this command only works in tickets!",
    "only_owner_can_do_that": f"❌ only {OWNER_NAME} can do that!",
    "this_role_was_not_found": "❌ role not found!"
}
